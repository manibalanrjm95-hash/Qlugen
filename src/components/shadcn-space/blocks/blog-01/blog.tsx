...
const blogData: BlogData[] = [
  {
    ...
    title: "How to scope an AI product MVP",
    date: "2026-03-01",
  },
  {
    ...
    <section ref={sectionRef} className="py-10 md:py-20">
      <div className="max-w-7xl xl:px-16 lg:px-8 px-4 mx-auto">
        <div className="flex flex-col gap-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
            ...
            >
              ...
              <h2 className="text-foreground text-3xl sm:text-5xl font-semibold">
                Practical ideas for teams building with AI
              </h2>
            </motion.div>
            {/* description */}
            <motion.p
          ...
          >
              Explore product thinking, engineering patterns, and launch lessons
              for AI apps, agents, automations, and integrations.
          </motion.p>
          </div>
          {/* blogs */}
