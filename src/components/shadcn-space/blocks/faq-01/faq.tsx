...
const FAQ_DATA = [
  {
    question: "What kind of AI development work do you do?",
    answer:
      "We build AI-powered products, custom agents, workflow automations, retrieval systems, integrations, and internal tools.",
  },
  {
    question: "Can you connect with our existing systems?",
    answer:
      "Yes. We integrate with your current tools, databases, APIs, documents, CRMs, and cloud infrastructure wherever possible.",
  },
  {
    question: "Can you start from a rough product idea?",
    answer:
      "Yes. We help shape the feature scope, user flow, data requirements, prototype path, and technical architecture.",
  },
  {
    question: "How do you keep AI builds secure?",
    answer:
      "We plan for access control, auditability, data boundaries, evaluation, and human review from the start.",
  },
  {
    question: "What does an engagement look like?",
    answer:
      "We start with discovery, define scope and architecture, build in focused sprints, launch, and iterate based on usage.",
  },
];
